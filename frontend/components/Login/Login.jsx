...
import { useAuth } from "../../context/AuthContext"; // Assuming AuthContext contains login logic

const Login = ({ toggleMode }) => {
  const { login, googleLogin } = useAuth(); // Extract login and googleLogin from context
    ...
    <div className="w-full max-w-md p-8 space-y-6">
      ...
      <div className="text-center">
        <p className="text-sm text-gray-600">
          ...
          <a href="#" className="text-indigo-600" onClick={(e) => toggleMode(e)}>Signup</a>
        </p>
